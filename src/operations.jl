...
# function mulvecop!(res::AbstractVector{T}, op1::AbstractLinearOperator, op2::AbstractLinearOperator, v::AbstractVector{T}) where T 
#   mul!(res, op2, v)
#   mul!(op1, res)

## Operator times operator.
function mul!(opres::AbstractLinearOperator, op1::AbstractLinearOperator, op2::AbstractLinearOperator)
  (m1, n1) = size(op1)
  (m2, n2) = size(op2)
  if m2 != n1
